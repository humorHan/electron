...
**Note:** It is not possible to have the OS sandbox active only for some renderers, if
[`app.enableSandbox`](app.md#appenablesandbox-experimental) is used, normal Electron windows cannot be created.
